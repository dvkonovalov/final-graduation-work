...
from src.controllers.service_controller import init_session, proxy_request, proxy_request_get
...
def create_app() -> Flask:
    ...
    app.add_url_rule('/proxy_get', view_func=proxy_request_get, methods = ['POST'])
    db.init_app(app)
